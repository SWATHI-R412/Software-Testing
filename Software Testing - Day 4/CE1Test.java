...
public class CE1Test {
  ...
  public void cE1() {
    ...
    driver.findElement(By.id("input-email")).sendKeys("727721euit167@skcet.ac.in");
    driver.findElement(By.id("input-password")).click();
    driver.findElement(By.id("input-password")).sendKeys("Sw@thi@412");
